...
local gameEndStats = {totalScore = 0, level = 0, highScore = 0}
...
function drawGameOverState()
    ...
    love.graphics.printf("Game Over!",titleFont,0,50,
        gameWidth,"center")
    love.graphics.printf("Score: " .. stats.totalScore, subtitleFont,0, 225 + 90,
        gameWidth,"center")
        love.graphics.printf("Level: " .. stats.level, subtitleFont,0,225 +120,
        gameWidth,"center")
        love.graphics.printf("Highscore: " .. stats.highScore, subtitleFont,0,225 +150,
        gameWidth,"center")
    love.graphics.printf("Press Enter to Play or Escape to exit",
        0,90, gameWidth,"center")
end
